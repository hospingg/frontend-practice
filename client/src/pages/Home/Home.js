        ...
        <>
          <div className={styles.container}>
            <div className={styles.headerBar}>
              ...
              <div className={styles.naming_contests_container}>
                <div>
                <h3>Naming Contests</h3>
                <p className={styles.naming_contests__text}>Custom name suggestions from 100s of naming experts as you are guided through our naming agency-style process</p>
                </div>
                <button className={styles.button__get_name}>Get a Custom Name</button>
              </div>
            </div>
